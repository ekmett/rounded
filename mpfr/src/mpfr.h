...
__MPFR_DECLSPEC void mpfr_init2_malloc _MPFR_PROTO ((mpfr_ptr, mpfr_prec_t));
__MPFR_DECLSPEC void mpfr_init _MPFR_PROTO ((mpfr_ptr));
__MPFR_DECLSPEC void mpfr_clear _MPFR_PROTO ((mpfr_ptr));
__MPFR_DECLSPEC void mpfr_clear_free _MPFR_PROTO ((mpfr_ptr));
...
__MPFR_DECLSPEC void mpfr_set_prec_realloc _MPFR_PROTO((mpfr_ptr, mpfr_prec_t));
