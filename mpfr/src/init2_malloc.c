/* mpfr_init2_malloc -- initialize a floating-point number with given precision
...
void
mpfr_init2_malloc (mpfr_ptr x, mpfr_prec_t p)
{
  mp_size_t xsize;
  mpfr_limb_ptr tmp;
  ...
  tmp   = (mpfr_limb_ptr) malloc (MPFR_MALLOC_SIZE(xsize));
